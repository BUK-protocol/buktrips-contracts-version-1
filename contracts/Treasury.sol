...
contract Treasury is AccessControl {
    ...
    */
    modifier onlyFactory(address addr) {
        require(addr == factory_contract, "Only Factory contract has Access");
        _;
    }
    ...
    * @notice This function can only be called by an address with `ADMIN_ROLE`
    */
    function withdrawFund(uint256 _total, address _currency, address _account) external onlyRole(ADMIN_ROLE) {
